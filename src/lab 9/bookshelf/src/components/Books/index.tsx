...
import { useAppDispatch, useBooksSelector } from '../../store/hooks'
import { setFilter } from '../../store/books'
...
const RdxBooksList = () => {
    ...
    useEffect(() => { dispatch(setFilter(searchTitle)) }, [searchTitle])

    const filteredBooks = books.filter(b => b.title.includes(searchTitle))
